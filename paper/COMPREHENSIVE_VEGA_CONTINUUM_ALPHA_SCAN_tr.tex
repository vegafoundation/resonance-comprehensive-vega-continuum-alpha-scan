...
\title{COMPREHENSIVE VEGA CONTINUUM ALPHA SCAN: Kavramsal Bir Çerçeve}
...
\begin{abstract}
Bu çalışma, COMPREHENSIVE VEGA CONTINUUM ALPHA SCAN'i Resonance Data ve QIRC paradigması içinde yeni bir kavramsal çerçeve olarak tanıtmaktadır.
